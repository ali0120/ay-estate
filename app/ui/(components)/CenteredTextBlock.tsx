...
const CenteredTextBlock: React.FC<CenteredTextBlockProps> = ({ heading, paragraph }) => {
    return (
        <div className="text-center mx-auto">
            ...
            <p className='text-[14px] lg:text-[18px] font-soraRegular text-RomanSilver leading-[22.4px] lg:leading-[28.8px] lg:w-[62%] lg:m-auto pt-[16px] lg:pt-[30px] pb-[30px] px-[9px] lg:px-0'>
                {paragraph}
            </p>
        </div>
    );
