...
const Properties = () => {
    return (
        <section className='bg-White text-Black'>
            <Box className='px-[20px] md:px-0 py-[50px] md:py-[80px]'>
                <Flex className="flex-col items-center justify-center pb-[48px] md:pb-[80px] text-center lg:text-start" >
