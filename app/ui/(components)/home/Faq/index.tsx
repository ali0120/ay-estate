        ...
        <section className='bg-White'>
            <Box p={{ base: 20, md: 100 }}>
                ...
                <Box className='mt-[50px] flex justify-center pb-[30px] md:pb-0' >
                    <Button h={{ base: 48, md: 56 }} className='w-full md:w-auto py-[15.5px] px-[35px] text-[12px] md:text-[18px] leading-[15.6px] md:leading-[23.4px] font-soraBold md:font-soraSemiBold text-ChineseBlack capitalize'>
                        Give a Quote
                    </Button>
                </Box>
            </Box>
