...
const Hero = () => {
    return (
        <section className='bg-Cultured ' >
            <Box className='px-[20px] xl:px-[80px] pt-[50px] lg:pt-[30px] pb-[50px] lg:pb-[70px]'>
                <Flex className='gap-[48px] lg:gap-[58px] flex-col md:flex-row'>
                    <Box className='lg:pt-[56px] w-full lg:w-1/2'>
                    ...
                    <Box className='w-full lg:w-1/2'>
                        <Image className='w-full lg:h-[500px]  object-contain' src={HeroImage} alt='hero image' />
                    </Box>
                </Flex>
            </Box>
        </section>
