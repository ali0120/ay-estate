        ...
        <section className='bg-ChineseBlack text-White relative overflow-hidden'>
            <div className='px-[20px] xl:px-[60px] py-[40px] lg:py-[60px]'>
                ...
                <div className='flex justify-center' >
                    <Button rightSection={<ArrowUpIcon />} className='relative z-10 h-[44px] md:h-[56px] md:w-[212px] w-full text-EerieBlack capitalize rounded-[40px] text-[14px] md:text-[18px] leading-[20px] md:leading-[28px] font-soraSemiBold '>
                        Start A Project
                    </Button>
                </div>
            </div>
